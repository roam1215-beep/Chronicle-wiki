...
- 라키아: 이오니아·도리아 사이 경계 소국, 테오도라의 고향. 이오니아엔 적국, 도리아엔 억압받는 백성(이중 소외). 발드의 약탈 대상. (모레아 산맥·산골짜기가 이 지역.)
- 발드: 전쟁이 끝난 줄 모르는 이오니아 낙오병. 만만한 라키아만 약탈. 해방군 자처하나 약탈자 = 위선. 인격에 따라 테오도라의 거울상(무모↔용기·교활↔지혜·위선↔정의).
- 무리(선주민): 이 땅의 원래 주인, 인간(정복자)에게 땅을 빼앗긴 자들. 칼리돈 숲 등에 깃듦. / 인간: 나중에 온 정복자(가해 인지 못 함). 테오도라조차 인간 측 시점의 맹점을 안음.
- 테오도라: 라키아인, 인간, 황혼 태생. 4주덕 중 절제가 빠짐 = "절제 없는 자"(신념대로 맹목적으로 나아가며 행동이 앞서는 자 — 두려움에 떠는 자가 아님).
