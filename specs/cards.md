...
예시 (잠정 — 작가 정의):
  산골짜기 길잡이  / 일반 / 길을 잘 읽는 안내인 / 민첩 굴림 실패 시 그 주사위 재굴림 (스테이지당 1회)
...
예시 (잠정 — 작가 정의):
  약초 / 일반 / 산골짜기 약초, 지혈 효과 / 건강 +0.5 후 소진
...
- 보급품 즉시발동 vs 쟁여두기 / 무기·도구·방어구 + 내구도(등급) 세부
- 운명 4죽음 × 3갈래 데이터 양산 (현 record 운명 1장 — 2층 미반영)
- 수치(요구면·상벌 크기·면 비율·ordeal fate_pull 갈래 ±) = 프로토/플레이테스트가 조임 (dice.md §미정)
