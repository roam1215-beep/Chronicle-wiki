...
부착 결:
  - 의지 지불해 부착 (배치 결 같은 자리, 패에서 인물 1명 지정)
  - 한 인물 1장비 (새 장비 부착 시 기존 = 묘지)
  - 부착 동안 효과 유지
  - 부착된 인물 사망 시 = 함께 묘지
```
...
6종:
  ...
  용병   mercenary  (배치 시 결정 결)
    배치:  병사형 또는 사수형 1종 선택 (결정 후 변경 X)
    이동:  선택한 결로
    전투:  선택한 결로
    시야:  1
